...
/** Context for a target-aware registered radial menu action. */
public record RadialMenuNpcActionContext(@Nonnull Player player,
                                         @Nonnull String menuKey,
                                         @Nonnull String optionId,
                                         @Nonnull String actionId,
                                         @Nonnull String source,
                                         @Nonnull Map<String, String> payload,
                                         @Nonnull RadialMenuNpcTarget npcTarget) {
    public RadialMenuNpcActionContext {
        ...
        Objects.requireNonNull(npcTarget, "npcTarget");
    }
}
